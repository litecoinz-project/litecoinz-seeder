...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "litecoinz-seeder\n"
...
extern "C" void* ThreadStats(void*) {
  ...
  do {
    ...
    printf(ANSI_COLOR_GREEN "%s" ANSI_COLOR_RESET " " ANSI_COLOR_CYAN "%i/%i" ANSI_COLOR_RESET
...
static const string mainnet_seeds[] = {"dnsseed.litecoinz.info", ""};
static const string testnet_seeds[] = {"testnet-seed.litecoinz.info", ""};
